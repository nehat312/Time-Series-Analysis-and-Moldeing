...
#%%
# 2. Consider the following joint density function for random variable X and Y with the following distribution:
      # a. Find the constant c.
      # b. Find the marginal density 𝑓 (𝜆 ) and 𝑓 (𝜆 )
      # c. Graph the marginal density function for random variable X and Y
            # show that the area under each curve is unity.
      # d. What is E[X]? what is E[Y]?
      # e. Find and graph 𝑓 (𝜆 |𝜆 ) . What is 𝑓 (𝜆 |𝜆 ) when 𝜆 = 0.5.
      # f. Find and graph 𝑓 (𝜆 |𝜆 ). What is 𝑓 (𝜆 |𝜆 ). when 𝜆 𝑌|𝑋 2 1 𝑌|𝑋 2 1 1
      # g. Are random variable X and Y independent?
